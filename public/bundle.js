...
/***/ function(module, exports, __webpack_require__) {
	...
	var _threadIds = __webpack_require__(242);

	var _threadIds2 = _interopRequireDefault(_threadIds);

	var _threadData = __webpack_require__(243);

	var _threadData2 = _interopRequireDefault(_threadData);

	var _apiReducer = __webpack_require__(244);
	...
	var initialState = {
		threadIds: {
			ids: _actions2.default.getAllData(),
			currentId: null
		}
	};
	...
	var febApp = (0, _redux.combineReducers)({
		//routing: routerReducer,
		threadIds: _threadIds2.default,
		threadData: _threadData2.default,
		apiReducer: _apiReducer2.default
	});
	...
	var store = (0, _redux.createStore)(febApp, initialState, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = {
	  idClickAction: function idClickAction(id) {
	  ...
	  authorAction: function authorAction(dispatch, author) {
	  ...
	  fetchingDataApi: function fetchingDataApi(id) {
	    //console.log('FetchingdatafromApi for '+id);
	    return { type: 'FetchingdatafromApi' };
	  },
	  receivedData: function receivedData(id, data) {
	  ...
	  getDataFromApi: function getDataFromApi(actions, id) {
	    //console.log('in actions getDataFromApi  '+id)
	    return function (dispatch) {
	      //console.log('in actions getDataFromApi1234')
	      dispatch(actions.fetchingDataApi(id));
	      return (0, _isomorphicFetch2.default)("https://query.yahooapis.com/v1/public/yql?q=" + "select * from weather.forecast where woeid in " + "(select woeid from geo.places(1) where text='London')&format=" + "json").then(function (response) {
	        if (response.status >= 400) {
	          throw new Error("Bad response from server");
	        }
	        return response.json();
	      }).then(function (json) {
	        return dispatch(actions.receivedData(id, json));
	      });
	    };
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ShowIds = __webpack_require__(215);

	var _ShowIds2 = _interopRequireDefault(_ShowIds);

	var _pagenation = __webpack_require__(241);
	...
	module.exports = _react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.Route, { path: 's', component: _ShowIds2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'p', component: _pagenation2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ShowIdData = __webpack_require__(216);

	var _ShowIdData2 = _interopRequireDefault(_ShowIdData);
	...
	var ShowIdss = function (_React$Component) {
		_inherits(ShowIdss, _React$Component);

		function ShowIdss() {
			_classCallCheck(this, ShowIdss);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ShowIdss).apply(this, arguments));
		}

		_createClass(ShowIdss, [{
			key: 'render',
	  	...
	  	if(this.props.currentId != NaN){
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.props.displayIds.map(function (id) {
						if (id == _this2.props.currentId) {
							return _react2.default.createElement(
								'button',
								{ style: buttonStyle, key: id,
									onClick: function onClick() {
										return _this2.props.idClick(id);
									} },
								'id=',
								id
							);
					...
					function () {
						if (_this2.props.currentId != null) {
							return _react2.default.createElement(_ShowIdData2.default, { authorClick: _this2.props.authorClick, IdData: _this2.props.IdData });
						}
					}()
				);
			}
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			idClick: function idClick(id) {
				dispatch(_actions2.default.idClickAction(id));
			},
			authorClick: function authorClick(author) {
				_actions2.default.authorAction(dispatch, author);
			}
		};
	};

	var ShowIds = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ShowIdss);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShowIdData = function (_React$Component) {
		_inherits(ShowIdData, _React$Component);

		function ShowIdData(props) {
			_classCallCheck(this, ShowIdData);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ShowIdData).call(this, props));
		...
		_createClass(ShowIdData, [{
			key: "updateText",
			value: function updateText(e) {
				var newTextVals = this.state.textVals.filter(function (val) {
					if (val.text.trim() == '') {
						//console.log("filter")
						return false;
					}
			...
			value: function textChange(e) {
				...
				var modified = false;
				var newTextVals = this.state.textVals.map(function (val) {
					if (val.id == _this2.props.IdData.id) {
						modified = true;
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							{ href: "#", onClick: function onClick(e) {
									e.preventDefault();_this3.props.authorClick(_this3.props.IdData.threadName);
								} },
							this.props.IdData.threadName
						)
					),
					function () {
						var match = _this3.state.textVals.filter(function (textVal) {
							//console.log(textVal);
							return textVal.id == _this3.props.IdData.id;
						});
						...
						if (match.length == 1) {
							return _react2.default.createElement(
								"p",
								null,
								_react2.default.createElement("input", { type: "text", onBlur: _this3.updateText, onChange: _this3.textChange,
									style: textStyle, value: match[0].text })
							);
						} else {
							return _react2.default.createElement(
								"p",
								null,
								_react2.default.createElement("input", { type: "text", onBlur: _this3.updateText, onChange: _this3.textChange,
									style: textStyle, placeholder: "enter text", value: "" })
							);
						}
					}()
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pageNtt = function (_React$Component) {
		_inherits(pageNtt, _React$Component);

		function pageNtt(props) {
			_classCallCheck(this, pageNtt);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(pageNtt).call(this, props));
			...
			_this.columnClick = _this.columnClick.bind(_this);
			_this.searchTextChange = _this.searchTextChange.bind(_this);
			_this.noOfRecChange = _this.noOfRecChange.bind(_this);
			_this.getManipulatedData = _this.getManipulatedData.bind(_this);
			_this.sort = _this.sort.bind(_this);
			_this.noOfRecChange = _this.noOfRecChange.bind(_this);
			return _this;
		}

		_createClass(pageNtt, [{
			key: 'columnClick',
			value: function columnClick(colName) {
			...
			key: 'noOfRecChange',
			value: function noOfRecChange() {
				this.setState({
					noOfRec: _reactDom2.default.findDOMNode(this.refs.mynoOfRecs).value
				});
			}
		}, {
			key: 'changePage',
			...
			value: function render() {
				...
				var data = this.getManipulatedData(); //this.props.data)

				var columns = ['id', 'threadID', 'threadName', 'authorName', 'text', 'timestamp'];
				var borderStyle = {
					border: 'solid black'
				};
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						null,
						'Is Fetching : ',
						this.props.isFetching ? 'true' : 'false'
					),
					_react2.default.createElement(
						'div',
						null,
						'Did Receive : ',
						this.props.didReceived ? 'true' : 'false'
					),
					function () {
						if (_this2.props.didReceived) {
							//console.log(this.props.apiData)
							return _react2.default.createElement(
								'div',
								null,
								JSON.stringify(_this2.props.apiData.query.created, null, 4)
							);
						} else {
							return _react2.default.createElement(
								'div',
					...
					_react2.default.createElement('input', { type: 'text', ref: 'mynoOfRecs', name: 'inputValue',
						defaultValue: this.state.noOfRec, placeholder: 'number Of Rec per page' }),
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								_this2.noOfRecChange();
							} },
						'set'
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								columns.map(function (colName) {
									if (_this2.state.sortColumn != null && _this2.state.sortColumn == colName) {
										return _react2.default.createElement(
											'th',
											{ style: borderStyle },
											_react2.default.createElement(
												'a',
												{ href: '#', onClick: function onClick(e) {
														e.preventDefault();_this2.columnClick(colName);
													} },
												colName
											),
											' -> ',
											_this2.state.sortOrder == 1 ? 'Asc' : 'Desc'
										);
									}
									return _react2.default.createElement(
										'th',
	  	...
	  	return true;
			...
			key: 'getManipulatedData',
			value: function getManipulatedData() {
				var dummyData = [{
					id: '1',
					threadID: 't_1',
					threadName: 'Jing',
			...
			key: 'sort',
			value: function sort(data, propName) {
				var _this3 = this;

				data.sort(function (a, b) {
					var result = a[propName] > b[propName] ? 1 : a[propName] == b[propName] ? 0 : -1;
					return result * _this3.state.sortOrder;
				});
				return data;
			}
		}]);
	...
	var mapDisptchToProps = function mapDisptchToProps(dispatch) {
		return {
			getData: function getData(id) {
				...
				dispatch(_actions2.default.getDataFromApi(_actions2.default, id));
			}
		};
	};

	var pageNt = (0, _reactRedux.connect)(mapStateToProps, mapDisptchToProps)(pageNtt);
...
/***/ function(module, exports) {
	...
	var threadIds = function threadIds() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { ids: [1, 2, 3], currentId: null } : arguments[0];
		var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var threadData = function threadData() {
...
/***/ function(module, exports) {
	...
	var apiReducer = function apiReducer() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { data: {}, id: null, fetching: false, received: false } : arguments[0];
		var action = arguments[1];
